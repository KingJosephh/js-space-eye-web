    ...
    filteredMapData.forEach((item) => {
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-sm btn-light-gray px-3 py-1" data-bs-toggle="modal" data-bs-target="#showAllParkModel" data-bs-show-park="${item.parkName}" data-bs-show-type="${item.type}" data-bs-show-address="${item.address}" data-bs-show-space="${item.space}" data-bs-show-in="${item.height}">長期方案</button>
            </div>
        </div>
    </div>`
    str += content
